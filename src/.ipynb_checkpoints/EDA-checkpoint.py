...
def sales_by_year():
     ...
     plt.savefig("sales_by_year.png", bbox_inches="tight")
     plt.close()
def profit_by_year():
     sns.lineplot(data=df1, x='year', y='profit')
     ax = plt.gca()
     ax.xaxis.set_major_locator(ticker.MultipleLocator(1))
     plt.savefig("profit_by_year.png", bbox_inches="tight")
     plt.close()
...
def sales_by_sub_category():
     ...
     plt.tight_layout()
     plt.savefig("sales_by_sub_category.png", bbox_inches="tight")
     plt.close()
...
def profit_by_sub_category():
     ...
     plt.tight_layout()
     plt.savefig("profit_by_sub_category.png", bbox_inches="tight")
     plt.close()
...
def show_distr_of_profitability():
     ...
     plt.savefig("distribution_of_profitability.png", bbox_inches="tight")
     plt.close()
...
def barplot_rentability():
    ...
    plt.tight_layout()
    plt.savefig("rentability_by_subcategories.png", bbox_inches="tight")
    plt.close()
...
def sales_v_by_state():
     ...
     plt.tight_layout()
     plt.savefig("sales_by_state.png", bbox_inches="tight")
     plt.close()
